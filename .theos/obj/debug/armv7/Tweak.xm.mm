...
@class SBThermalController; @class SBIconAnimator; @class SBIdleTimerDescriptorFactory; @class SBApplication; @class SBBackgroundMultitaskingManager; @class SBApplicationAutoLaunchService; @class SpringBoard; @class SBApplicationInfo; @class BCBatteryDevice; @class SBTelephonyManager; 
