...
@class SpringBoard; @class SBBackgroundMultitaskingManager; @class SBIdleTimerDescriptorFactory; @class SBTelephonyManager; @class SBApplicationAutoLaunchService; @class SBApplication; @class SBThermalController; @class SBIconAnimator; @class BCBatteryDevice; @class SBApplicationInfo; 
