...
@class SpringBoard; @class SBApplication; @class BCBatteryDevice; @class SBIconAnimator; @class SBTelephonyManager; @class SBBackgroundMultitaskingManager; @class SBThermalController; @class SBApplicationInfo; @class SBApplicationAutoLaunchService; @class SBIdleTimerDescriptorFactory; 
