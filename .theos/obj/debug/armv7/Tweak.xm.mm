...
@class SpringBoard; @class SBIconAnimator; @class SBTelephonyManager; @class SBApplicationAutoLaunchService; @class BCBatteryDevice; @class SBIdleTimerDescriptorFactory; @class SBBackgroundMultitaskingManager; @class SBApplication; @class SBApplicationInfo; @class SBThermalController; 
