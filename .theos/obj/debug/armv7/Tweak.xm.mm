...
@class SBTelephonyManager; @class SBIconAnimator; @class SBBackgroundMultitaskingManager; @class SBIdleTimerDescriptorFactory; @class SBApplicationInfo; @class SBApplication; @class SBThermalController; @class SBApplicationAutoLaunchService; @class BCBatteryDevice; @class SpringBoard; 
