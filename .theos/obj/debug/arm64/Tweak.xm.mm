...
@class SBApplicationInfo; @class SBThermalController; @class SBApplication; @class SBIconAnimator; @class SBTelephonyManager; @class SBApplicationAutoLaunchService; @class SBIdleTimerDescriptorFactory; @class SBBackgroundMultitaskingManager; @class BCBatteryDevice; @class SpringBoard; 
