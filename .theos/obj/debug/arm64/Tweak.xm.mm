...
@class SBIdleTimerDescriptorFactory; @class SBApplicationAutoLaunchService; @class SBTelephonyManager; @class SBThermalController; @class SpringBoard; @class SBBackgroundMultitaskingManager; @class SBApplicationInfo; @class SBIconAnimator; 
