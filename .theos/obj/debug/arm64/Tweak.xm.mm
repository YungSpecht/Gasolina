...
@class SBApplicationAutoLaunchService; @class SBApplicationInfo; @class SBIconAnimator; @class SBThermalController; @class SBBackgroundMultitaskingManager; @class SBTelephonyManager; @class SpringBoard; @class SBIdleTimerDescriptorFactory; @class BCBatteryDevice; @class SBApplication; 
