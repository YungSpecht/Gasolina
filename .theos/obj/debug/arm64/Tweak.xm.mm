...
@class SBIconAnimator; @class SBThermalController; @class SpringBoard; @class SBBackgroundMultitaskingManager; @class SBApplicationAutoLaunchService; @class SBApplication; @class SBTelephonyManager; @class BCBatteryDevice; @class SBIdleTimerDescriptorFactory; @class SBApplicationInfo; 
