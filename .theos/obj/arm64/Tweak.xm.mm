...
@class SBIdleTimerDescriptorFactory; @class SBIconAnimator; @class SBBackgroundMultitaskingManager; @class SBThermalController; @class SpringBoard; @class SBApplicationInfo; @class SBApplication; @class SBApplicationAutoLaunchService; @class SBTelephonyManager; @class BCBatteryDevice; 
