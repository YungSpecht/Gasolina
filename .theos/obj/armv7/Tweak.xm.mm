...
@class SBIconAnimator; @class BCBatteryDevice; @class SBApplication; @class SBBackgroundMultitaskingManager; @class SpringBoard; @class SBTelephonyManager; @class SBThermalController; @class SBApplicationInfo; @class SBIdleTimerDescriptorFactory; @class SBApplicationAutoLaunchService; 
